...
- Use [GitHub Private Vulnerability Reporting](https://github.com/brianschroeder/agent-references/security/advisories/new)
  for this repo, or
- Open a [draft security advisory](https://github.com/brianschroeder/agent-references/security/advisories)
